<title>Tingle..Handmade with Love</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/user/css/normalize.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/user/icomoon/icomoon.css')}}">
